...
var buddyATKDict={"ATKUP(小)1"     :"0.11",
                  "ATKUP(小)2"     :"0.12",
                  "ATKUP(小)3"     :"0.13",
                  "ATKUP(小)4"     :"0.14",
                  "ATKUP(小)5"     :"0.15",
...
var healContinueDict = {"HP回復(極小)1" :"0",
                        "HP回復(極小)2" :"0",
                        "HP回復(極小)3" :"0",
                        "HP回復(極小)4" :"0",
                        "HP回復(極小)5" :"0",
    ...
    var atk = 0;
        for (let i=0; i<data.length; i++){
            if(data[i].name == imgsrc) {
                ...
                document.getElementById("cGrowType"   + modalId).value = data[i].rare + data[i].growtype;
                document.getElementById("cATK"   + modalId).value = Number(data[i].atk);
                document.getElementById("cHP"    + modalId).value = Number(data[i].hp);
                document.getElementById("cATKhidden"   + modalId).value = Number(data[i].atk);
                document.getElementById("cHPhidden"    + modalId).value = Number(data[i].hp);
                document.getElementById("cBaseATKhidden"   + modalId).value = Number(data[i].base_atk);
                document.getElementById("cBaseHPhidden"    + modalId).value = Number(data[i].base_hp);
                ...
                document.getElementById("cbuddy2St" + modalId).value  = data[i].buddy2s;
                document.getElementById("cbuddy3Name" + modalId).value  = data[i].buddy3c;
                document.getElementById("cbuddy3St" + modalId).value  = data[i].buddy3s;
                ...
                for (let d = 1; d <= 5; d++) {
                    if(document.getElementById("cname" + d).value != "") {
                        dDict[document.getElementById("cname" + d).value] = document.getElementById("cname" + d).value;
                    }
                }
                for (let d = 1; d <= 5; d++) {
                    if(document.getElementById("cduo" + d).innerHTML in dDict) {
                        document.getElementById("cM2pow" + d).value = "デュオ魔法";
                    } else if (document.getElementById("cM2pow" + d).value == "デュオ魔法") {
...
function changeLevel(inid){
    ...
    let totsurate = 1;
    if (selectedOption == '未'){totsurate=0.964;}
    var HPperLv = (maxHP-baseHP)/(hiddenLv-1);
    var ATKperLv = (maxATK-baseATK)/(hiddenLv-1);
    var leveldef = hiddenLv - inLv;
    document.getElementById("cHP" + inid).value = ((maxHP - HPperLv * leveldef)*totsurate).toFixed(1);
...
function calc(){
    ...
    // バディチェック用辞書作成
    for (let i = 1; i <= 5; i++) {
        charaDict[document.getElementById("cname" + i).value] = document.getElementById("cname" + i).value;
    }
    var totalHP = 0;
    var totalHealHP = 0;
    // データ系列フィルタ処理
    ...
    for (let i = 1; i <= 5; i++) {
        ...
        // HP回復計算ロジック
        var heal = 0;
        var heal1key = document.getElementById("cM1heal" + i).value + document.getElementById("cM1Lv" + i).value;
        var heal2key = document.getElementById("cM2heal" + i).value + document.getElementById("cM2Lv" + i).value;
        var heal3key = document.getElementById("cM3heal" + i).value + document.getElementById("cM3Lv" + i).value;
        ...
        if (selected_magic.includes(1)){heal += Number(heal1) * Number(document.getElementById("cATK"   + i).value);}
        if (selected_magic.includes(2)){heal += Number(heal2) * Number(document.getElementById("cATK"   + i).value);}
        if (selected_magic.includes(3)){heal += Number(heal3) * Number(document.getElementById("cATK"   + i).value);}
        
        var healc1 = heal1key in healContinueDict ? healContinueDict[heal1key] : 0;
        var healc2 = heal2key in healContinueDict ? healContinueDict[heal2key] : 0;
        var healc3 = heal3key in healContinueDict ? healContinueDict[heal3key] : 0;
        if (selected_magic.includes(1)){heal += 3 * Number(healc1) * Number(document.getElementById("cHP"   + i).value);}
        if (selected_magic.includes(2)){heal += 3 * Number(healc2) * Number(document.getElementById("cHP"   + i).value);}
        if (selected_magic.includes(3)){heal += 3 * Number(healc3) * Number(document.getElementById("cHP"   + i).value);}
        ...
        var buddy2hpRatio = 0;
        var buddy3hpRatio = 0;
        var buddy1key = document.getElementById("cbuddy1St" + i).value + document.getElementById("cbuddy1Lv" + i).value;
        ...
        var buddy2key = document.getElementById("cbuddy2St" + i).value + document.getElementById("cbuddy2Lv" + i).value;
        ...
        var buddy3key = document.getElementById("cbuddy3St" + i).value + document.getElementById("cbuddy3Lv" + i).value;
        ...
        var buddyhp = buddy1hpRatio * tmpHP + buddy2hpRatio * tmpHP + buddy3hpRatio * tmpHP;
        ...
        var buddy1key = document.getElementById("cbuddy1St" + i).value + document.getElementById("cbuddy1Lv" + i).value;
        if (document.getElementById("cbuddy1Name" + i).value in charaDict) {
            buddy1atkRatio = buddy1key in buddyATKDict ? buddyATKDict[buddy1key] : 0;
        }
        var buddy2key = document.getElementById("cbuddy2St" + i).value + document.getElementById("cbuddy2Lv" + i).value;
        if (document.getElementById("cbuddy2Name" + i).value in charaDict) {
            buddy2atkRatio = buddy2key in buddyATKDict ? buddyATKDict[buddy2key] : 0;
        }
        var buddy3key = document.getElementById("cbuddy3St" + i).value + document.getElementById("cbuddy3Lv" + i).value;
        if (document.getElementById("cbuddy3Name" + i).value in charaDict) {
            buddy3atkRatio = buddy3key in buddyATKDict ? buddyATKDict[buddy3key] : 0;
        }
        var tmpATK = document.getElementById("cATK" + i).value;
        var buddyatk = buddy1atkRatio * tmpATK + buddy2atkRatio * tmpATK + buddy3atkRatio * tmpATK;
        ...
        var M1atkbuf1 = document.getElementById("cM1buf1" + i).value + document.getElementById("cM1buf1Lv" + i).value;
        var M1atkbuf2 = document.getElementById("cM1buf2" + i).value + document.getElementById("cM1buf2Lv" + i).value;
        var M1atkbuf1add = (M1atkbuf1 in atkbuffDict ? atkbuffDict[M1atkbuf1] : 0) * suATK;
        var M1atkbuf2add = (M1atkbuf2 in atkbuffDict ? atkbuffDict[M1atkbuf2] : 0) * suATK;
        
        var M1kou1 = suATK + M1atkbuf1add + M1atkbuf2add + buddyatk;

        // 攻撃倍率
        var M1magicRatioKey = document.getElementById("cM1pow" + i).value + document.getElementById("cM1Lv" + i).value;
        var M1magicRatio = (M1magicRatioKey in magicDict ? magicDict[M1magicRatioKey] : 0);
        // 無属性補正
        var M1muAdjust = (M1attribute == "無" ? 1.1 : 1);
        // ダメージバフ
        var M1dmgbuf1 = document.getElementById("cM1buf1" + i).value + document.getElementById("cM1buf1Lv" + i).value;
        var M1dmgbuf2 = document.getElementById("cM1buf2" + i).value + document.getElementById("cM1buf2Lv" + i).value;
        ...
        var M1kou2 = Number(M1magicRatio) * Number(M1muAdjust) + Number(M1dmgbuf1add) + Number(M1dmgbuf2add);
        ...
        var M1damage = M1kou1 * M1kou2 * M1rengeki;
        ...
        damageM1Data.vszendamage = Math.max(Number(vsM1hidamage),Number(vsM1kidamage),Number(vsM1mizudamage));
        ...
        var M2atkbuf1 = document.getElementById("cM2buf1" + i).value + document.getElementById("cM2buf1Lv" + i).value;
        var M2atkbuf2 = document.getElementById("cM2buf2" + i).value + document.getElementById("cM2buf2Lv" + i).value;
        var M2atkbuf1add = (M2atkbuf1 in atkbuffDict ? atkbuffDict[M2atkbuf1] : 0) * suATK;
        var M2atkbuf2add = (M2atkbuf2 in atkbuffDict ? atkbuffDict[M2atkbuf2] : 0) * suATK;
        
        var M2kou1 = suATK + M2atkbuf1add + M2atkbuf2add + buddyatk;

        // 攻撃倍率
        var M2magicRatioKey = document.getElementById("cM2pow" + i).value + document.getElementById("cM2Lv" + i).value;
        var M2magicRatio = (M2magicRatioKey in magicDict ? magicDict[M2magicRatioKey] : 0);
        // 無属性補正
        var M2muAdjust = (M2attribute == "無" ? 1.1 : 1);
        // ダメージバフ
        var M2dmgbuf1 = document.getElementById("cM2buf1" + i).value + document.getElementById("cM2buf1Lv" + i).value;
        var M2dmgbuf2 = document.getElementById("cM2buf2" + i).value + document.getElementById("cM2buf2Lv" + i).value;
        ...
        var M2kou2 = Number(M2magicRatio) * Number(M2muAdjust) + Number(M2dmgbuf1add) + Number(M2dmgbuf2add);
        ...
        var M2damage = M2kou1 * M2kou2 * M2rengeki;
        ...
        damageM2Data.vszendamage = Math.max(Number(vsM2hidamage),Number(vsM2kidamage),Number(vsM2mizudamage));
        ...
        var M3atkbuf1 = document.getElementById("cM3buf1" + i).value + document.getElementById("cM3buf1Lv" + i).value;
        var M3atkbuf2 = document.getElementById("cM3buf2" + i).value + document.getElementById("cM3buf2Lv" + i).value;
        var M3atkbuf1add = (M3atkbuf1 in atkbuffDict ? atkbuffDict[M3atkbuf1] : 0) * suATK;
        var M3atkbuf2add = (M3atkbuf2 in atkbuffDict ? atkbuffDict[M3atkbuf2] : 0) * suATK;
        
        var M3kou1 = suATK + M3atkbuf1add + M3atkbuf2add + buddyatk;

        // 攻撃倍率
        var M3magicRatioKey = document.getElementById("cM3pow" + i).value + document.getElementById("cM3Lv" + i).value;
        var M3magicRatio = (M3magicRatioKey in magicDict ? magicDict[M3magicRatioKey] : 0);
        // 無属性補正
        var M3muAdjust = (M3attribute == "無" ? 1.1 : 1);
        // ダメージバフ
        var M3dmgbuf1 = document.getElementById("cM3buf1" + i).value + document.getElementById("cM3buf1Lv" + i).value;
        var M3dmgbuf2 = document.getElementById("cM3buf2" + i).value + document.getElementById("cM3buf2Lv" + i).value;
        ...
        var M3damage = M3kou1 * M3kou2 * M3rengeki;
        ...
        damageM3Data.vszendamage = Math.max(Number(vsM3hidamage),Number(vsM3kidamage),Number(vsM3mizudamage));
        ...
        if (selected_magic.includes(1)){damageDataList.push(damageM1Data);}
        if (selected_magic.includes(2)){damageDataList.push(damageM2Data);}
        if (selected_magic.includes(3)){damageDataList.push(damageM3Data);}
        if (filterAttribute == "全属性"){
            if (selected_magic.includes(1)){damageList.push(Math.max(vsM1hidamage, vsM1kidamage, vsM1mizudamage, vsM1mudamage));}
            if (selected_magic.includes(2)){damageList.push(Math.max(vsM2hidamage, vsM2kidamage, vsM2mizudamage, vsM2mudamage));}
            if (selected_magic.includes(3)){damageList.push(Math.max(vsM3hidamage, vsM3kidamage, vsM3mizudamage, vsM3mudamage));}
        }
        if (filterAttribute == "対火属性"){
            if (selected_magic.includes(1)){damageList.push(Number(vsM1hidamage));}
            if (selected_magic.includes(2)){damageList.push(Number(vsM2hidamage));}
            if (selected_magic.includes(3)){damageList.push(Number(vsM3hidamage));}
        }
        if (filterAttribute == "対木属性"){
            if (selected_magic.includes(1)){damageList.push(Number(vsM1kidamage));}
            if (selected_magic.includes(2)){damageList.push(Number(vsM2kidamage));}
            if (selected_magic.includes(3)){damageList.push(Number(vsM3kidamage));}
        }
        if (filterAttribute == "対水属性"){
            if (selected_magic.includes(1)){damageList.push(Number(vsM1mizudamage));}
            if (selected_magic.includes(2)){damageList.push(Number(vsM2mizudamage));}
            if (selected_magic.includes(3)){damageList.push(Number(vsM3mizudamage));}
        }
        if (filterAttribute == "対無属性"){
            if (selected_magic.includes(1)){damageList.push(Number(vsM1mudamage));}
            if (selected_magic.includes(2)){damageList.push(Number(vsM2mudamage));}
            if (selected_magic.includes(3)){damageList.push(Number(vsM3mudamage));}
        }
    }
    let score = [0,0,0,0,0];
    if (filterAttribute == "全属性"){
    ...
    document.getElementById("easyscore1T").innerHTML  = (score[0] * 0.1152).toFixed();
    document.getElementById("easyscore2T").innerHTML  = (score[1] * 0.1104).toFixed();
...
fulldata = 		[{label: 'HP',
    			...
    			data: [document.getElementById("cHP1").value,
    			...
    			data: [document.getElementById("cHPbuddy1").value,
    			...
    			data: [document.getElementById("cHPheal1").value,
    			...
    			data: [document.getElementById("cM1HiDamage1").value,
    			...
    			data: [document.getElementById("cM1KiDamage1").value,
    			...
    			data: [document.getElementById("cM1MizuDamage1").value,
    			...
    			data: [document.getElementById("cM1MuDamage1").value,
    			...
    			stack: 'Stack 5',
    			backgroundColor: 'rgba(255, 20, 20, 0.4)',
    			data: [document.getElementById("cM2HiDamage1").value,
    			...
    			stack: 'Stack 6',
    			backgroundColor: 'rgba(20, 255, 20, 0.4)',
    			data: [document.getElementById("cM2KiDamage1").value,
    			...
    			stack: 'Stack 7',
    			backgroundColor: 'rgba(20, 20, 255, 0.4)',
    			data: [document.getElementById("cM2MizuDamage1").value,
    			...
    			stack: 'Stack 8',
    			backgroundColor: 'rgba(140, 140, 140, 0.4)',
    			data: [document.getElementById("cM2MuDamage1").value,
                ...
                stack: 'Stack 9',
                backgroundColor: 'rgba(255, 20, 20, 0.4)',
                data: [document.getElementById("cM3HiDamage1").value,
                ...
                stack: 'Stack 10',
                backgroundColor: 'rgba(20, 255, 20, 0.4)',
                data: [document.getElementById("cM3KiDamage1").value,
                ...
                stack: 'Stack 11',
                backgroundColor: 'rgba(20, 20, 255, 0.4)',
                data: [document.getElementById("cM3MizuDamage1").value,
                ...
                stack: 'Stack 12',
                backgroundColor: 'rgba(140, 140, 140, 0.4)',
                data: [document.getElementById("cM3MuDamage1").value,
    ...
    $myChart = new Chart(ctx, {
    	type: 'bar',
    	data: {
    		labels: [document.getElementById("cname1").value,
