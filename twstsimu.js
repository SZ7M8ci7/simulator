...
function changeImg(imgsrc) {
  ...
  for (let i = 0; i < data.length; i++) {
    if (data[i].name == imgsrc) {
      ...
      document.getElementById("cM1buf3" + modalId).value = "";
      document.getElementById("cM1buf4" + modalId).value = "";
      document.getElementById("cM1buf5" + modalId).value = "";
      document.getElementById("cM1buf6" + modalId).value = "";
      document.getElementById("cM1buf1Lv" + modalId).value = "10";
      document.getElementById("cM1buf2Lv" + modalId).value = "10";
      document.getElementById("cM1buf3Lv" + modalId).value = "10";
      document.getElementById("cM1buf4Lv" + modalId).value = "10";
      document.getElementById("cM1buf5Lv" + modalId).value = "10";
      document.getElementById("cM1buf6Lv" + modalId).value = "10";
      ...
      document.getElementById("cM2buf3" + modalId).value = "";
      document.getElementById("cM2buf4" + modalId).value = "";
      document.getElementById("cM2buf5" + modalId).value = "";
      document.getElementById("cM2buf6" + modalId).value = "";
      document.getElementById("cM2buf1Lv" + modalId).value = "10";
      document.getElementById("cM2buf2Lv" + modalId).value = "10";
      document.getElementById("cM2buf3Lv" + modalId).value = "10";
      document.getElementById("cM2buf4Lv" + modalId).value = "10";
      document.getElementById("cM2buf5Lv" + modalId).value = "10";
      document.getElementById("cM2buf6Lv" + modalId).value = "10";
      ...
      document.getElementById("cM3buf3" + modalId).value = "";
      document.getElementById("cM3buf4" + modalId).value = "";
      document.getElementById("cM3buf5" + modalId).value = "";
      document.getElementById("cM3buf6" + modalId).value = "";
      document.getElementById("cM3buf1Lv" + modalId).value = "10";
      document.getElementById("cM3buf2Lv" + modalId).value = "10";
      document.getElementById("cM3buf3Lv" + modalId).value = "10";
      document.getElementById("cM3buf4Lv" + modalId).value = "10";
...
function calc() {
  try {
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      var buddy2key =
        document.getElementById("cbuddy2St" + i).value +
      ...
      var buddy3key =
        document.getElementById("cbuddy3St" + i).value +
